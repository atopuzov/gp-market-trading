...
const std::type_info* Min::getArgType(unsigned int inN, Beagle::GP::Context& ioContext) const
{
...
const std::type_info* Min::getReturnType(Beagle::GP::Context& ioContext) const
{
...
// Vraca najmanju vrjednost dionice kroz period
void Min::execute(GP::Datum& outDatum, GP::Context& ioContext)
{
