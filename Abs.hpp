...
class Abs : public Beagle::GP::Primitive {

public:

  typedef Beagle::AllocatorT<Abs,Beagle::GP::Primitive::Alloc> Alloc;
  typedef Beagle::PointerT<Abs,Beagle::GP::Primitive::Handle> Handle;
  typedef Beagle::ContainerT<Abs,Beagle::GP::Primitive::Bag> Bag;
