...
class EMA : public Beagle::GP::Primitive {

public:
	typedef Beagle::AllocatorT<EMA,Beagle::GP::Primitive::Alloc> Alloc;
	typedef Beagle::PointerT<EMA,Beagle::GP::Primitive::Handle> Handle;
	typedef Beagle::ContainerT<EMA,Beagle::GP::Primitive::Bag> Bag;
